...
public final class MetadataUtil
{
    ...
    public static final JsonCodec<Map<String, List<BiosTable>>> CATALOG_CODEC;
    public static final JsonCodec<BiosTable> TABLE_CODEC;
    public static final JsonCodec<BiosColumnHandle> COLUMN_CODEC;
    ...
    static {
        ...
        CATALOG_CODEC = codecFactory.mapJsonCodec(String.class, listJsonCodec(BiosTable.class));
        TABLE_CODEC = codecFactory.jsonCodec(BiosTable.class);
        COLUMN_CODEC = codecFactory.jsonCodec(BiosColumnHandle.class);
    }
